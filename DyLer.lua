...
{
{text = '➢ البوتات الوهميه',type = 'text'},{text = '‹ حذف بوت ›ات الوهميه',type = 'text'},
},
{
...
send(msg.chat_id,msg.id,'\n➢ احصائيات جميع البوتات المصنوعه \n ➢ عدد المجموعات '..Redis:get(DyLer.."All:gp:st")..' مجموعه \n➢ عدد المشتركين '..Redis:get(DyLer.."All:pv:st")..' مشترك',"html",true)
end
-----ban all
...
--------mange bots
if text == "‹ حذف بوت ›ات الوهميه" then
...
if text == 'ال‹ السورس ›' or text == '‹ السورس ›' or text == 'يا ‹ السورس ›' or text == 'source' then
