...
send(msg.chat_id,msg.id,"↯︙اهلا بك في مصنع بوتات الحمايه\n↯︙اصنع بوت مجاني على سورس دايلر\n↯︙لايحتوي على مشاكل تحديث 64bit\n↯︙قناه السورس : ‹ @IIIIIIQ ›","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
{
{text = '(Source Ch)', url = "https://t.me/IIIIIIQ"},
},
}
local msg_id = msg.id/2097152/0.5 
...
local T =[[
لانشاء بوت اتبع ما يلي اذهب الى بوت فاذر ( @BotFather ) اضغط بدء او start ارسل الامر التالي ‹ /newbot › بعدها ارسل اسم البوت مثال ( بوت حماية ) بعدها ارسل يوزر البوت بشرط نهاية يوزر البوت ينتهي بكلمه bot مثال (shhwogwbot) سيرسل لك توكن عباره عن ارقام وحروف اضغط ضغطه واحد ليتم نسخه ثم قم بارساله للمصنع
]]
keyboard = {} 
...
{
{text = '(Ch Source )', url = "https://t.me/IIIIIIQ"}
}, 
}
